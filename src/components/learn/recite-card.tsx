          ...
          <div className="mt-auto pt-2 flex-shrink-0">
            <div className="flex gap-4">
              <button
                ...
                className="flex-1 flex items-center justify-center gap-2 py-3.5 px-5 text-base bg-red-100 text-red-700 rounded-xl hover:bg-red-200 dark:bg-red-900/30 dark:text-red-400 cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
                disabled={isDisabled}
              >
              ...
              <button
                ...
                className="flex-1 flex items-center justify-center gap-2 py-3.5 px-5 text-base bg-green-100 text-green-700 rounded-xl hover:bg-green-200 dark:bg-green-900/30 dark:text-green-400 cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
                disabled={isDisabled}
              >
              ...
              <button
                onClick={onSkip}
                className="py-3.5 px-5 text-base bg-gray-100 dark:bg-gray-700 rounded-xl hover:bg-gray-200 dark:hover:bg-gray-600 cursor-pointer transition-colors"
              >
                跳过
              </button>
            </div>
